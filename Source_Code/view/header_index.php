        ...
        <div class="header">
            ...
            <nav>
                ...
                <ul>
                    ...
                    {
                        echo '<li><a href="view/aboutUs.php">About Us</a></li>';
                        echo
                        ...
                        <div class="dropdown">
                            <li><a href="view/profile.php?id='.$_SESSION['UserID'].'">Profile Page</a></li>
                            <li><a href="view/editProfile.php?id='.$_SESSION['UserID'].'">Edit Profile</a></li>
